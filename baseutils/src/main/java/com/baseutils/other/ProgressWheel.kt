...
import com.mobilyte.baseutils.R
...
class ProgressWheel : View {
    ...
    private fun setAnimationEnabled() {
        ...
        animationValue = when {
            currentApiVersion >= Build.VERSION_CODES.JELLY_BEAN_MR1 -> Settings.Global.getFloat(context.contentResolver,
                    Settings.Global.ANIMATOR_DURATION_SCALE, 1f)
            else -> Settings.System.getFloat(context.contentResolver,
    ...
    private fun setupBounds(layout_width: Int, layout_height: Int) {
        ...
        if (!fillRadius) {
            ...
            circleBounds = RectF((xOffset + barWidth).toFloat(), (yOffset + barWidth).toFloat(), (xOffset + circleDiameter - barWidth).toFloat(),
