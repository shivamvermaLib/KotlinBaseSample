package com.baseutils.sharedpreference
...
object Prefs {
     ...
     */
    @Deprecated("", ReplaceWith("Builder().setContext(context).build()", "com.shivam.baseutils.Prefs.Builder"))
     ...
     * *
     * @return `true` if the storage containsKey this key value, `false` otherwise.
     * *
